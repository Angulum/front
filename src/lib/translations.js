export const translations = {
  es: {
    ...
    knowOurTeam: "¡Conoce a cada uno de nuestros integrantes!",

    // REAL ESTATE CARD
    rooms: "Habitaciones",
    bathrooms: "Baños",
    squarem: "Metros cuadrados",
    price: "ARS / mensual",
  ...
  en: {
    ...
    // NAVBAR
    goAdmin: "Admin Panel",
    addRealEstate: "Publish Real Estate",
    account: "My account",

    slogan: "Your home, our commitment",
    heroDesc: "Search real estate to buy or lease in Rosario",
    heroQuestion: "What are you looking for?",

    // CARD
    cardContact: "Contact the realtor:",
    ...
    // TEAM
    ourTeam: "Our team",
    knowOurTeam: "Get to know each of our team members!",

    // REAL ESTATE CARD
    rooms: "Rooms",
    bathrooms: "Bathrooms",
    squarem: "Squared meters",
    price: "ARS / mensual",
