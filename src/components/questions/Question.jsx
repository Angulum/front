...
const QuestionBox = ({
    ...
    try {
      ...
      setQuestions((prevQuestions) => [
        ...prevQuestions,
        {
          ...
          id: newQuestion.id,
          answer: null,
          realEstateId: newQuestion.realEstateId,
        },
      ]);
  ...
  const onSubmitAnswer = async () => {
    ...
    try {
      ...
      setQuestions((prevQuestions) =>
        prevQuestions.map((q) =>
          q.id === selectedQuestionId ? { ...q, answer: answer } : q
        )
      );
      ...
      setAnswerErrors((prev) => ({
        ...prev,
        [selectedQuestionId]:
          "Hubo un problema al enviar tu respuesta. Intenta nuevamente.",
      }));
    } finally {
