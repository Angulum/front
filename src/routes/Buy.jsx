...
const generateProperties = () => {
    return Array.from({ length: 20 }, (_, index) => ({
        ...
        price: `$${(Math.floor(Math.random() * 500000) + 200000).toLocaleString()} ARS / mensual`,
        description: 'Descripción de la propiedad. Detalles adicionales pueden incluir tamaño, características especiales, etc.',
